...
const eventName = 'Chúc Crush Sinh Nhật Vui Vẻ ạ:<';
const titleCard = 'Tặng người ấy';
const contentCard = 'Chúc crush tớ yêu tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với em trong hôm nay và cả những ngày sau';
